...
{
    public abstract class IdVerificationServiceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IdVerificationServiceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IdVerificationServiceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IdVerificationServiceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IdVerificationServiceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IdVerificationServiceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IdVerificationServiceDbContext, Task<T>> func)
        {
            T result;
