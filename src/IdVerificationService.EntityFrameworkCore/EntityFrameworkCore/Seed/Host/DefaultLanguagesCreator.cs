...
namespace IdVerificationService.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly IdVerificationServiceDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = IdVerificationServiceConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(IdVerificationServiceDbContext context)
        {
            _context = context;
        }
