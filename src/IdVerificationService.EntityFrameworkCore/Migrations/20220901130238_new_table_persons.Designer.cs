...
namespace IdVerificationService.Migrations
{
    ...
    [Migration("20220901130238_new_table_persons")]
    partial class new_table_persons
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdVerificationService.EntityFrameworkCore.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("IdVerificationService.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("IdVerificationService.Authorization.Users.User", null)
                        .WithMany("Claims")
